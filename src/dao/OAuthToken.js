 ...
 */
OAuthTokenDao.getAccessToken = (bearerToken, getTokenCB) => {
 ...
 * @param  {Function} getTokenCB
 */
OAuthTokenDao.getRefreshToken = (bearerToken, getTokenCB) => {
  models.OAuthToken.find({
    attributes: [
      'refreshToken',
 ...
 */
OAuthTokenDao.saveAccessToken = (token, saveTokenCB) => {
 ...
 */
OAuthTokenDao.deleteAccessToken = (token, deleteCB) => {
